  ...
  const steps = [
    {
      ...
      icon: 1,
      content: <Security stepper={stepper} type="wizard-modern" />,
    },
    {
      id: "personal-info",
      title: "اطلاعات هویتی",
    ...
    },
    {
      ...
      icon: 4,
      content: <GenderInformation stepper={stepper} type="wizard-modern" />,
    },
    {
      id: "access",
      title: "دسترسی ها",
      ...
      icon: 5,
      content: <Access stepper={stepper} type="wizard-modern" />,
    },
    {
      id: "Preview",
